...
#connect_debug_port u_ila_0/probe0 [get_nets [list {result[0]} {result[1]} {result[2]} {result[3]} {result[4]} {result[5]} {result[6]} {result[7]} {result[8]} {result[9]} {result[10]} {result[11]} {result[12]} {result[13]} {result[14]} {result[15]}]]
...
#connect_debug_port u_ila_0/probe2 [get_nets [list clk_100mhz_IBUF_BUFG]]
