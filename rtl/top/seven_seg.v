...
always @(*) begin
    case (LED_BCD)
        4'd0: LED_out = 7'b1000000; // 0
        4'd1: LED_out = 7'b1111001; // 1
        4'd2: LED_out = 7'b0100100; // 2
        4'd3: LED_out = 7'b0110000; // 3
        4'd4: LED_out = 7'b0011001; // 4
        4'd5: LED_out = 7'b0010010; // 5
        4'd6: LED_out = 7'b0000010; // 6
        4'd7: LED_out = 7'b1111000; // 7
        4'd8: LED_out = 7'b0000000; // 8
        4'd9: LED_out = 7'b0010000; // 9
